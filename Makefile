...
Nageoire.o : Nageoire.h Nageoire.cpp Accessoire.h Bestiole.h 
	g++ -Wall -std=c++11  -c Nageoire.cpp -I .

Carapace.o : Carapace.h Carapace.cpp Accessoire.h Bestiole.h 
	g++ -Wall -std=c++11  -c Carapace.cpp -I .

Camouflage.o : Camouflage.h Camouflage.cpp Accessoire.h Bestiole.h 
